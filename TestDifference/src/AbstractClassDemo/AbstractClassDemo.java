...
class B extends A { //this is derived class, so it'll implement abstract method-callme().Because it extends abstract class
...
class C extends test//this is derived class, so it'll implement abstract method-callme().Because it extends abstract class
{
